...
Bajo_desempeño <-  Datos_limpios%>%
  arrange(`Nombre completo`) %>%                       #Se ordenan los adtos de manera alfabetica respecto de "Nombre completo"
  filter(Desempeño == 0)                               #Se filtra que usuarios han tenido un desempeño de 0%

View(Bajo_desempeño)

write_xlsx(
  list(
    Datos_limpios = Datos_limpios,                    #Se genera hoja dentro del archivo "Base_Limpia.xlsx" con Datos_limpios
    Bajo_desempeño = Bajo_desempeño                   #Se genera hoja con el conjunto de datos "Bajo_desempeño"
  ),
  "Base_Limpia.xlsx"                                  
)
